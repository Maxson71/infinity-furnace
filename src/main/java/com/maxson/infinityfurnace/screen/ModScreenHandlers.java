...
public class ModScreenHandlers {
    public static final ScreenHandlerType<InfinityFurnaceScreenHendler> INFINITY_FURNACE_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(InfinityFurnace.MOD_ID, "infinity_furnace"),
                    new ExtendedScreenHandlerType<>(InfinityFurnaceScreenHendler::new));
